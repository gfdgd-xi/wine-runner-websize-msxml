...
html = f"""<!DOCTYPE html>
<head>
    <title>MSXML 运行库列表（来自 Wine 运行器）</title>
    <meta name="viewport" content="width=device-width" initial-scale="1" />
    <meta charset='UTF-8'>
    <meta http-equiv="content-language" content="zh-cn">
    <meta name="description" content="用于下载 MSXML 运行库的网站" >
</head>

<body>
    <h1>MSXML 运行库列表（来自 Wine 运行器）</h1>
    <p>点击下方链接下载</p>
...
lists = requests.get("https://code.gitlink.org.cn/gfdgd_xi/wine-runner-list/raw/branch/master/msxml/list.json").json()
for i in lists:
